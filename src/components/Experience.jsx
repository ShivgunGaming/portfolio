...
const ExperienceCard = ({ experience, onClick, isActive, isMobile }) => {
  return (
    <div
      ...
      style={{ marginBottom: "2rem" }} // Add margin-bottom to ensure spacing
    >
      {(isActive || isMobile) && (
...
const Experience = () => {
  ...
  return (
    <div className="sm:my-20 pt-32 md:pt-48">
      <motion.div variants={textVariant()}>
        <h2 className={`${styles.sectionText} text-center`}>Experience</h2>
      </motion.div>

      <div className="relative mt-10 md:mt-20 md:p-20 pl-5 flex flex-col items-center sm:flex-row sm:items-start">
        ...
        <div className="flex justify-end z-10 sm:block hidden md:pr-20">
